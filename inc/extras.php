...
function rootstrap_social(){
    ...
    if ($services)
        echo '<li style="padding-bottom:6px;vertical-align:bottom"><a class="social-profile" style="font-size:14px;font-weight:300">follow us:</a></li>';
...
function rootstrap_header_menu() {
        ...
        wp_nav_menu(array(
                    ...
                    'depth'             => 2,
                    'container'         => 'div',
                    'container_class'   => 'navbar-collapse navbar-ex1-collapse sidebar-nav',
